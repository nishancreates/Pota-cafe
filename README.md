...
A fully animated, multi-page restaurant website
built with pure HTML, CSS, and JavaScript.
No frameworks. No libraries.

## 🌐 Live Demo
[View Live Site](https://YOURUSERNAME.github.io/void-restaurant)
...
- Mobile responsive
-  any aesthetic/ customizable 

## 📁 Pages
- `index.html` — Homepage
- `about.html` — Our Story & Team
- `services.html` — Full Menu
...
DM me on LinkedIn: https://www.linkedin.com/in/nishan-kumar-rokaya/
